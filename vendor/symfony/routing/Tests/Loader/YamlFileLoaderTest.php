...
class YamlFileLoaderTest extends TestCase
{
    ...
    public function testLoadRouteWithControllerAttribute()
    {
        ...
        $routeCollection = $loader->load('routing.yaml');
    ...
    public function testLoadingLocalizedRoute()
    {
        ...
        $routes = $loader->load('localized-routing.yaml');
    ...
    {
        $loader = new YamlFileLoader(new FileLocator(array(__DIR__.'/../Fixtures/localized')));
        $routes = $loader->load('importing-localized-routing.yaml');
    ...
    {
        $loader = new YamlFileLoader(new FileLocator(array(__DIR__.'/../Fixtures/localized')));
        $routes = $loader->load('importer-with-locale-imports-non-localized-routing.yaml');
