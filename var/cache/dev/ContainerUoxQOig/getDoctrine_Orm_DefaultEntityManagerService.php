...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ClientRepository' => function () {
    return ($this->privates['App\Repository\ClientRepository'] ?? $this->load('getClientRepositoryService.php'));
}, 'App\\Repository\\CountRepository' => function () {
    return ($this->privates['App\Repository\CountRepository'] ?? $this->load('getCountRepositoryService.php'));
...
}, 'App\\Repository\\RecordRepository' => function () {
    return ($this->privates['App\Repository\RecordRepository'] ?? $this->load('getRecordRepositoryService.php'));
