...
// Returns the private 'App\Repository\CountRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CountRepository.php';

return $this->privates['App\Repository\CountRepository'] = new \App\Repository\CountRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
